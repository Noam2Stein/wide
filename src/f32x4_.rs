...
impl_simd! {
  ...
  #[inline]
  fn shuffle(self: [f32x4; 2], indices: u32x4) -> f32x4 {
    cast(cast::<[f32x4; 2], [u32x4; 2]>(self).shuffle(indices))
  }

  #[inline]
  fn zeroing_shuffle(self: [f32x4; 2], indices: u32x4) -> f32x4 {
    cast(cast::<[f32x4; 2], [u32x4; 2]>(self).zeroing_shuffle(indices))
  }

  #[inline]
  fn wrapping_shuffle(self: [f32x4; 2], indices: u32x4) -> f32x4 {
    cast(cast::<[f32x4; 2], [u32x4; 2]>(self).wrapping_shuffle(indices))
  }

  #[inline]
  fn shuffle(self: [f32x4; 3], indices: u32x4) -> f32x4 {
    cast(cast::<[f32x4; 3], [u32x4; 3]>(self).shuffle(indices))
  }

  #[inline]
  fn zeroing_shuffle(self: [f32x4; 3], indices: u32x4) -> f32x4 {
    cast(cast::<[f32x4; 3], [u32x4; 3]>(self).zeroing_shuffle(indices))
  }

  #[inline]
  fn wrapping_shuffle(self: [f32x4; 3], indices: u32x4) -> f32x4 {
    cast(cast::<[f32x4; 3], [u32x4; 3]>(self).wrapping_shuffle(indices))
  }

  #[inline]
  fn shuffle(self: [f32x4; 4], indices: u32x4) -> f32x4 {
    cast(cast::<[f32x4; 4], [u32x4; 4]>(self).shuffle(indices))
  }

  #[inline]
  fn zeroing_shuffle(self: [f32x4; 4], indices: u32x4) -> f32x4 {
    cast(cast::<[f32x4; 4], [u32x4; 4]>(self).zeroing_shuffle(indices))
  }

  #[inline]
  fn wrapping_shuffle(self: [f32x4; 4], indices: u32x4) -> f32x4 {
    cast(cast::<[f32x4; 4], [u32x4; 4]>(self).wrapping_shuffle(indices))
  }
