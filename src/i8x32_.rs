...
impl_simd! {
  ...
  ///
  /// For [`i8x32`] specifically, additional guarantees are made about out of
  ...
  #[inline]
  pub fn zeroing_shuffle(self, indices: u8x32) -> Self {
    self.cast_unsigned().zeroing_shuffle(indices).cast_signed()
  }

  #[inline]
  pub fn wrapping_shuffle(self, indices: u8x32) -> Self {
    self.cast_unsigned().wrapping_shuffle(indices).cast_signed()
  }

  #[inline]
  fn shuffle(self: [i8x32; 2], indices: u8x32) -> i8x32 {
    cast(cast::<[i8x32; 2], [u8x32; 2]>(self).shuffle(indices))
  }

  #[inline]
  fn zeroing_shuffle(self: [i8x32; 2], indices: u8x32) -> i8x32 {
    cast(cast::<[i8x32; 2], [u8x32; 2]>(self).zeroing_shuffle(indices))
  }

  #[inline]
  fn wrapping_shuffle(self: [i8x32; 2], indices: u8x32) -> i8x32 {
    cast(cast::<[i8x32; 2], [u8x32; 2]>(self).wrapping_shuffle(indices))
  }

  #[inline]
  fn shuffle(self: [i8x32; 3], indices: u8x32) -> i8x32 {
    cast(cast::<[i8x32; 3], [u8x32; 3]>(self).shuffle(indices))
  }

  #[inline]
  fn zeroing_shuffle(self: [i8x32; 3], indices: u8x32) -> i8x32 {
    cast(cast::<[i8x32; 3], [u8x32; 3]>(self).zeroing_shuffle(indices))
  }

  #[inline]
  fn wrapping_shuffle(self: [i8x32; 3], indices: u8x32) -> i8x32 {
    cast(cast::<[i8x32; 3], [u8x32]>(self).wrapping_shuffle(indices))
  }

  #[inline]
  fn shuffle(self: [i8x32; 4], indices: u8x32) -> i8x32 {
    cast(cast::<[i8x32; 4], [u8x32; 4]>(self).shuffle(indices))
  }

  #[inline]
  fn zeroing_shuffle(self: [i8x32; 4], indices: u8x32) -> i8x32 {
    cast(cast::<[i8x32; 4], [u8x32; 4]>(self).zeroing_shuffle(indices))
  }

  #[inline]
  fn wrapping_shuffle(self: [i8x32; 4], indices: u8x32) -> i8x32 {
    cast(cast::<[i8x32; 4], [u8x32; 4]>(self).wrapping_shuffle(indices))
  }
