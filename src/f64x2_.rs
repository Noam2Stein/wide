...
impl_simd! {
  ...
  #[inline]
  fn shuffle(self: [f64x2; 2], indices: u64x2) -> f64x2 {
    cast(cast::<[f64x2; 2], [u64x2; 2]>(self).shuffle(indices))
  }

  #[inline]
  fn zeroing_shuffle(self: [f64x2; 2], indices: u64x2) -> f64x2 {
    cast(cast::<[f64x2; 2], [u64x2; 2]>(self).zeroing_shuffle(indices))
  }

  #[inline]
  fn wrapping_shuffle(self: [f64x2; 2], indices: u64x2) -> f64x2 {
    cast(cast::<[f64x2; 2], [u64x2; 2]>(self).wrapping_shuffle(indices))
  }

  #[inline]
  fn shuffle(self: [f64x2; 3], indices: u64x2) -> f64x2 {
    cast(cast::<[f64x2; 3], [u64x2; 3]>(self).shuffle(indices))
  }

  #[inline]
  fn zeroing_shuffle(self: [f64x2; 3], indices: u64x2) -> f64x2 {
    cast(cast::<[f64x2; 3], [u64x2; 3]>(self).zeroing_shuffle(indices))
  }

  #[inline]
  fn wrapping_shuffle(self: [f64x2; 3], indices: u64x2) -> f64x2 {
    cast(cast::<[f64x2; 3], [u64x2; 3]>(self).wrapping_shuffle(indices))
  }

  #[inline]
  fn shuffle(self: [f64x2; 4], indices: u64x2) -> f64x2 {
    cast(cast::<[f64x2; 4], [u64x2; 4]>(self).shuffle(indices))
  }

  #[inline]
  fn zeroing_shuffle(self: [f64x2; 4], indices: u64x2) -> f64x2 {
    cast(cast::<[f64x2; 4], [u64x2; 4]>(self).zeroing_shuffle(indices))
  }

  #[inline]
  fn wrapping_shuffle(self: [f64x2; 4], indices: u64x2) -> f64x2 {
    cast(cast::<[f64x2; 4], [u64x2; 4]>(self).wrapping_shuffle(indices))
  }
